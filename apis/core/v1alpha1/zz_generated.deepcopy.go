...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlagDEnvVar) DeepCopyInto(out *FlagDEnvVar) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlagDEnvVar.
func (in *FlagDEnvVar) DeepCopy() *FlagDEnvVar {
	if in == nil {
		return nil
	}
	out := new(FlagDEnvVar)
