...
type EnvConfig struct {
	...
	FlagdProxyTag            string `envconfig:"FLAGD_PROXY_TAG" default:"v0.7.3"`
	...
	FlagdTag            string `envconfig:"FLAGD_TAG" default:"v0.12.3"`
	...
	// renovate: datasource=github-tags depName=open-feature/flagd/flagd
	SidecarTag           string `envconfig:"SIDECAR_TAG" default:"v0.12.3"`
