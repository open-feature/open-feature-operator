...
FLAGD_IMG ?= ghcr.io/open-feature/flagd:v0.0.3
...
release-manifests: manifests kustomize
	cd config/manager && $(KUSTOMIZE) edit set image controller=${IMG} && $(KUSTOMIZE) edit set image ghcr.io/open-feature/flagd=${FLAGD_IMG}
