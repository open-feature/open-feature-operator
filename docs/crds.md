...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#featureflagconfigurationspecfeatureflagspec-1">featureFlagSpec</a></b></td>
        <td>object</td>
        <td>
          FeatureFlagSpec is the structured representation of the feature flag specification<br/>
        </td>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#featureflagconfigurationspecfeatureflagspecflagskey-1">flags</a></b></td>
        <td>map[string]object</td>
        <td>
          <br/>
        </td>
...
### FeatureFlagConfiguration.spec.featureFlagSpec.flags[key]
<sup><sup>[↩ Parent](#featureflagconfigurationspecfeatureflagspec-1)</sup></sup>
