...
func main() {
	...
	// the following default values are chosen as a result of load tttesting: https://github.com/open-feature/flagd/blob/main/tests/loadtest/README.MD#performance-observations
