...
| `sidecarConfiguration.image.tag`           | current flagd version: `v0.5.2` | Sets the version tag for the injected sidecar container.                                                                                                                                                                                                   |
...
| `flagdProxyConfiguration.image.tag`            | current flagd-proxy version: `v0.2.2`   | Sets the tag for the flagd-proxy deployment                                  |
