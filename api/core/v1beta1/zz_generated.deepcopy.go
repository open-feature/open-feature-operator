...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FlagMetadata) DeepCopyInto(out *FlagMetadata) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FlagMetadata.
func (in *FlagMetadata) DeepCopy() *FlagMetadata {
	if in == nil {
		return nil
	}
	out := new(FlagMetadata)
