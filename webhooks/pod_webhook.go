...
//+kubebuilder:rbac:groups=rbac.authorization.k8s.io,resources=clusterrolebindings,verbs=get;list;watch;update,resourceNames=open-feature-operator-flagd-kubernetes-sync;
