...
func run(ctx context.Context, cfg *rest.Config, scheme *runtime.Scheme, opts *envtest.WebhookInstallOptions, backfillErrChan chan error) error {
	...
	go podMutator.BackfillPermissions(ctx, backfillErrChan)
